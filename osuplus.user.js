                ...
                $("<div class='osuplusSettingsContent'>").append(
                    ...
                    $("<div>").append(
                        ...
                        $("<table class='osuplusSettingsTable' width='100%'>").append(
                            ...
                            makeSettingRow("显示 Mino 镜像下载", null, makeCheckboxOption("showMirror5")),
                            makeSettingRow("显示日期", null, makeCheckboxOption("showDates")),
                    ...
                    $("<div>").append(
                        ...
                        $("<table class='osuplusSettingsTable' width='100%'>").append(
                            ...
                            makeSettingRow("显示BWS排名", "", makeCheckboxOption("showBWS"))
                        )
                    ),
                    $("<div>").append(
                        "<h2>PP排名</h2>",
                    ...
                    $("<div>").append(
                        "<h2>谱面列表</h2>",
                        $("<table class='osuplusSettingsTable' width='100%'>").append(
                            makeSettingRow("强制显示难度", "不需要再用鼠标指着（旧网页设置，对新网页不起作用）", makeCheckboxOption("forceShowDifficulties"))
                        )
                    ),
                    $("<div>").append(
                        "<h2>多人游戏</h2>",
